...
def main():
    ...
    Configura argumentos, crea sockets IPv4/IPv6, lanza el proceso moderador y los hilos de escucha.
    """
    ...
    ipv6_socket.bind(('::', port))  # Enlaza socket IPv6 a todas las interfaces
    ...
    print(f"[ESCUCHANDO] Servidor IPv6 en [::]:{port}")  # Mensaje de escucha IPv6
